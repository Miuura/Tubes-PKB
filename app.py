...
st.set_page_config(page_title="Tugas Besar Pengenalan Kecerdasan Buatan", page_icon=":sparkles:")

st.title(':blue[Prediction Sirtuin6 Molecules] 🔬')
st.markdown("""
### :books: Tugas Besar PKB Kelompok 1:
